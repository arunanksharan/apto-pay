...
describe('parseURL', () => {
  describe('parsing', () => {
    describe('when given correct params', () => {
      it('should parse successfully', () => {
        const url =
          'aptos:mvines9iiHiQTysrwkJjGf2gb9Ex9jXJX8ns3qwf2kN?amount=0.000000001&reference=82ZJ7nbGpixjeDCmEhUcmwXYfvurzAgGdtSMuHnUgyny&label=Michael&message=Thanks%20for%20all%20the%20fish&memo=OrderId5678';

        const { recipient, amount, reference, label, message } = parseURL(
          url
        ...
        expect(
          reference![0]!.equals(
            new PublicKey('82ZJ7nbGpixjeDCmEhUcmwXYfvurzAgGdtSMuHnUgyny')
          )
        ).toBe(true);
      ...
      it('should parse with spl-token', () => {
        const url =
          'aptos:mvines9iiHiQTysrwkJjGf2gb9Ex9jXJX8ns3qwf2kN?amount=1.01&spl-token=82ZJ7nbGpixjeDCmEhUcmwXYfvurzAgGdtSMuHnUgyny&label=Michael&message=Thanks%20for%20all%20the%20fish&memo=OrderId5678';
      ...
      it('should parse without an amount', () => {
        const url =
          'aptos:mvines9iiHiQTysrwkJjGf2gb9Ex9jXJX8ns3qwf2kN?reference=82ZJ7nbGpixjeDCmEhUcmwXYfvurzAgGdtSMuHnUgyny&label=Michael&message=Thanks%20for%20all%20the%20fish&memo=OrderId5678';
  ...
  describe('errors', () => {
    ...
    it.each([['1milliondollars'], [-0.1], [-100]])(
      ...
      (amount) => {
        const url = `aptos:mvines9iiHiQTysrwkJjGf2gb9Ex9jXJX8ns3qwf2kN?amount=${amount}`;
    ...
    it('throws an error on invalid token', () => {
      const url =
        'aptos:mvines9iiHiQTysrwkJjGf2gb9Ex9jXJX8ns3qwf2kN?amount=1&spl-token=0xffff';
    ...
    it('throws an error on invalid reference', () => {
      const url =
        'aptos:mvines9iiHiQTysrwkJjGf2gb9Ex9jXJX8ns3qwf2kN?amount=1&reference=0xffff';
